...
public class Constants {
    ...
    public static final String[] PERMISSIONS={"permission.READ_CALENDAR"};
    ...
    public static String WorkLocationString="WorkLocationString";
    public static String HomeLatitudeString="homelatitude";
    public static String HomeLongitudeString="homelongitude";
